...
function ExperienceSection() {
  const experiences = [
    ...
    },
    {
      ...
      company: "ARPlanet",
      summary: "(An IPO enterprise in Taiwan, dedicated to providing augmented and virtual reality solutions.)",
    ...
    },
    {
      ...
      summary: "(Singapore-based digital media platform with over 33k paid subscriptions.)",
...
function SkillsSection() {
  const skills = {
    technical: ["Python", "SQL", "Tableau", "Looker", "Excel", "Statistical Analysis"],
    business: [
